...
class RiskStage:
 name="RISK_ENGINE"; component="risk-stage"
 ...
 def execute(self,*,scan_id:str,chip_id:str,correlation_id:str,features,cnn,anomaly,controls:dict[str,Any]):
  self._persist(scan_id,chip_id,correlation_id,EventType.STAGE_STARTED,{"status":"PROCESSING"})
  try:
   result=self.service.decide(features,cnn,anomaly,controls).to_dict()
