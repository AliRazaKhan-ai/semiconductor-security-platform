"""Run deterministic feature extraction and persist the model contract."""
...
class FeatureExtractionStage:
 name="FEATURE_EXTRACTION"; component="feature-extraction-stage"
 ...
 def execute(self,*,scan_id:str,chip_id:str,correlation_id:str,evidence:dict[str,Any]):
  self._persist(scan_id,chip_id,correlation_id,EventType.STAGE_STARTED,{"status":"PROCESSING"})
  try:
   result=self.service.extract(evidence).to_dict()
