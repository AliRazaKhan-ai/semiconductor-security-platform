"""Run unknown-pattern PyTorch anomaly inference."""
...
class PyTorchStage:
 name="PYTORCH_ANOMALY"; component="pytorch-stage"
 ...
 def execute(self,*,scan_id:str,chip_id:str,correlation_id:str,features):
  self._persist(scan_id,chip_id,correlation_id,EventType.STAGE_STARTED,{"status":"PROCESSING"})
  try:
   result=self.service.infer(features).to_dict()
